...
| # | Example | README ref | Status | Notes |
|---|---------|-----------|--------|-------|
| 7 | Fine-tune from NeMo2 ckpt (`train_evo2 --finetune-ckpt-dir`) | Fine-tuning → NeMo2 | ⬜ | Reuse converted 1B; mock-data fine-tune |
...
| 9 | LoRA fine-tuning (`train_evo2 --lora-finetune`) | LoRA Fine-tuning | ⬜ | Reuse converted 1B as `--finetune-ckpt-dir` |
